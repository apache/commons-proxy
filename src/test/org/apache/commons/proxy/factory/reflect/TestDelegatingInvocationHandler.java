...
public class TestDelegatingInvocationHandler extends TestCase
{
    ...
    {
        final DelegatingInvocationHandler invocationHandler = new DelegatingInvocationHandler()
        {
    ...
    public void testClassLoaderCreateProxy()
    {
        ...
        final Echo echo = ( Echo )invocationHandler.createProxy( Thread.currentThread().getContextClassLoader() );
        assertEquals( "message", echo.echoBack( "message" ) );
    }
